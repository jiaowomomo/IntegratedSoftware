...
namespace AutomationSystem.TextShow
{
    public partial class TextShowForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            hObjectViewer1.AddShowText(new Halcon.ShowText(Convert.ToDouble(textBoxX.Text), Convert.ToDouble(textBoxY.Text), textBoxHead.Text + "测试" + textBoxEnd.Text, comboBoxColor.Text));
